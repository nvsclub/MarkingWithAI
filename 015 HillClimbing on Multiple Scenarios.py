...
def hillclimb():
    ...
    pd.DataFrame(register).to_csv(f'results/hillclimb_newadversary{adv}_{export_time}.csv', index=False)


# Run algorithm on multiple adversaries
adv = 2
adversary = meval.default_adversary_2
hillclimb()

adv = 3
adversary = meval.default_adversary_3
hillclimb()

adv = 4
adversary = meval.default_adversary_4
hillclimb()

adv = 5
adversary = meval.default_adversary_5
hillclimb()